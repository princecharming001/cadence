...
export async function generateText({ system, user, maxTokens = 600, model = MODEL }) {
...
export async function generateJson({ system, user, schema, maxTokens = 1500, model = MODEL, toolName = 'emit', toolDescription = 'Emit the result in the required shape.' }) {
