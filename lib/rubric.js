...
- Avoid heavy markdown: no section headers (#), no bold-on-everything, no nested bullets. A simple dash list of a few items is fine when you're genuinely listing options; otherwise just talk.
