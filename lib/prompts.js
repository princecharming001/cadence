...
export const LINKEDIN_RUBRIC = `HOW TO WRITE A GREAT LINKEDIN POST (follow literally):
1. First line is the hook and stands alone — it decides the "see more" click.
2. Short paragraphs, 1-2 sentences each. White space is rhythm.
3. Concrete beats abstract: numbers, moments, names of real things.
4. No "I'm humbled/thrilled to announce" voice. No "Agree?" engagement bait.
5. End with one genuine question or a clean takeaway line, not both.
6. 0-3 hashtags at the very end, only if the user's own posts use them.`
