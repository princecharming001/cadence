...
GUARDRAIL: if sentiment skews negative, include a learning to cool the cadence or fix the message — NEVER a learning that exploits outrage for engagement.${negFlag ? '\nThis campaign HAS a significant negative-sentiment signal: you MUST emit one kind="audience" learning to slow down / fix the message, addressing the specific complaint above.' : ''}`
