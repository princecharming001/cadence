...
export const PHASE_GATES = {
  ...
  textElement: true, imageElement: true, animFade: true, resizeHandle: false, timelineTrim: false,
  // render gates (enforced by the normalizer; flip on per phase):
  rotation: false, xfade: false, kenBurns: false, clipTrim: false, moveAnim: false, wysiwygPng: false, musicBed: false, pip: false,
}
...
export function normalizeEditPlanV2(raw, { brief = '', wantsGen = false, genReady = false, workerFilters = {} } = {}) {
  ...
  for (const rs of rawScenes) {
    ...
    const dur = sc.duration == null ? null : clampNum(sc.duration, 1, 15, null)
